...
const inputs = {
  global: { lin: 134.96, long_barre: 12, botte_ha6: 36, botte_ha8: 21, botte_ha10: 13, botte_ha12: 9,
    poids_sac: 50, briques_m2: 12, hourdis_m2: 10, long_planche: 4,
    hauteur_montee: 0.22, montes_par_sac: 3,
    camion_sable: 6, camion_g0525: 20, camion_g1525: 25, densite_gravier: 1.5 },
  s1: { larg: 0.80, ep: 0.10, dosage: 250 },
  s2: { larg: 0.80, ht: 0.20, dosage: 350, n_barres: 4, esp: 0.20, long_traverse: 0.85 },
  s3: { long: 0.80, larg: 0.80, prof: 0.40, np: 25, dosage: 350, n_barres: 4, esp: 0.25, long_traverse: 1.35 },
  s4: { n_barres: 4, ht: 1.50, np: 25, esp: 0.15, long_etrier: 1.0, dosage: 350, sect_b: 0.25, sect_h: 0.25 },
  s5: { ht_murs: 1.0 },
  s6: { larg: 0.20, ht: 0.15, dosage: 350, n_barres: 4, esp: 0.20, long_traverse: 0.70 },
  s7: { ht_murs: 3.0 },
  s8: { larg: 0.20, ht: 0.15, dosage: 350, n_barres: 4, esp: 0.20, long_traverse: 0.70 },
  s9: { larg: 0.20, ht: 0.15, dosage: 350, n_barres: 4, esp: 0.20, long_traverse: 0.70 },
  s10: { long_dall: 20.30, larg: 9.15 },
  s11: { larg_dall: 9.15, ep: 0.05, dosage: 350 },
  s12: { n_barres: 4, np: 3, esp: 0.15, long_etrier: 1.20, dosage: 350, sect_b: 0.25, sect_h: 0.35 },
  s13: { larg: 0.10, ht: 0.20, np: 18, esp_etr: 0.20, long_etrier: 0.70, dosage: 350 },
  s14: { esp: 0.20 },
  s15: { larg_dall: 9.15, ep: 0.12, dosage: 350 },
};

const g = inputs.global;
const LB=g.long_barre, B6=g.botte_ha6, B8=g.botte_ha8, B10=g.botte_ha10, B12=g.botte_ha12;
...
const tot_cim = [vb1,vb2,vb3,vb4,vb6,vb8,vb9,vb11,vb12,vb13,vb15]
  .reduce((a,b,i) => a + b*[250,350,350,350,350,350,350,350,350,350,350][i], 0);
...
const sac_mac = Math.ceil((s5.ht_murs/g.hauteur_montee/g.montes_par_sac) + (s7.ht_murs/g.hauteur_montee/g.montes_par_sac));
...
const ha10 = (g.lin*s2.n_barres/LB/B10) + (s3.np*s3.n_barres*s3.long/LB/B10)
           + (g.lin*s6.n_barres/LB/B10) + (g.lin*s8.n_barres/LB/B10)
           + (g.lin*s9.n_barres/LB/B10) + (s10.long_dall*2*s13.np/LB/B10);
const ha12 = (s4.n_barres*s4.ht*s4.np/LB/B12) + (s12.n_barres*s10.larg*s12.np/LB/B12);
const ha8  = s10.long_dall/s14.esp/B8;
const ha6  = (g.lin/s2.esp)*s2.long_traverse/LB/B6
